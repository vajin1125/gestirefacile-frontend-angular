...
@Injectable()
export class MyBusinessService implements Resolve<any>
{
    routeParams: any;
    business: Business;
    ...
    getBusiness(): Promise<any>
    {
        return new Promise((resolve, reject) => {
            ...
            {
                this._httpClient.get(Config.prop.apiEndpoint + "mybusiness/search.php?oid=" + this.routeParams.id)
    ...
    saveBusiness(business, logo:File): Promise<any>
    {
        ...
        return new Promise((resolve, reject) => {
            this._httpClient.post(Config.prop.apiEndpoint+"mybusiness/update.php", formData)
                .subscribe((response: any) => {
                    //this.business = response[0];
    ...
    {  
        ...
        return new Promise((resolve, reject) => {
            this._httpClient.post(Config.prop.apiEndpoint+"mybusiness/insert.php", formData)
                .subscribe((response: any) => {
                    //this.business = response[0];
                    this.business = response;
                        this.onBusinessChanged.next(this.business);
