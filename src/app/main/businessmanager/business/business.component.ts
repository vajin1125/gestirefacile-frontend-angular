...
export class BusinessComponent implements OnInit, OnDestroy {
    ...
    createBusinessForm(): FormGroup {
        this.businessForm = this._formBuilder.group({
            ...
            validity_from: [this.business.validity_from, Validators.required],
            validity_to: [this.business.validity_to, Validators.required],
            ...
            enabled: [this.business.enabled, Validators.required],
